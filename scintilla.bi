...
''
''
'' scintilla -- header translated with help of SWIG FB wrapper
''
'' NOTICE: This file is part of the FreeBASIC Compiler package and can't
''         be included in other distributions without authorization.
''
''
#ifndef __scintilla_bi__
#define __scintilla_bi__

Declare Function Scintilla_LinkLexers cdecl Alias "Scintilla_LinkLexers" As Integer

Type uptr_t As UInteger
Type sptr_t As Integer
Type SciFnDirect As Function cdecl (ByVal As sptr_t, ByVal As UInteger, ByVal As uptr_t, ByVal As sptr_t) As sptr_t
...
#define SC_FOLDLEVELBOXHEADERFLAG &h4000
#define SC_FOLDLEVELBOXFOOTERFLAG &h8000
#define SC_FOLDLEVELCONTRACTED &h10000
#define SC_FOLDLEVELUNINDENT &h20000
